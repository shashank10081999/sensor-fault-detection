...
class DataTransformation():
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        try:
            ...
            input_feature_test_final ,taget_feature_test_final = smt.fit_resample(transformed_input_test_feature , target_feature_test_df)

            train_array = np.c_[input_feature_train_final , np.array(target_feature_train_final)]
            test_array = np.c_[input_feature_test_final , np.array(taget_feature_test_final)]
